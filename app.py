...
movies = pd.read_csv("/Users/joych/Desktop/dashboard/final code/github/updated/movies_list_df.csv", index_col=0)
directors = pd.read_csv("/Users/joych/Desktop/dashboard/final code/github/updated/directors_rating.csv", index_col=0)
...
movies = movies.drop(['Year Range'], axis=1)
